...
## Phase 0 — Make it fundable (months 0–2)
...
- [ ] 5–10 design-partner LOIs (restaurants, schools, ag-extension offices)
...
|-------|----------|-------------:|----------------:|
| **Hardware appliance** | Restaurants, schools, prosumers | High | 9–12 mo |
...
### 2a) Non-dilutive (target $200k–$450k, dilutes zero)
...
- **State agtech grants** — most US states have $25k–$100k matching
...
### 2c) Pre-seed angels (target $500k–$750k, ~15% dilution)
...
- **Crowd Supply** (built for open hardware) — also doubles as market
  validation. Typical agtech project: $200k–$600k raise + 200–800 units
  pre-sold.
- **Kickstarter** if you want consumer reach > open-hardware credibility.

### 2e) Eventual seed round (month 12–18)
- $2M–$3M at a $10M–$14M cap once you have ~50 units in field and
